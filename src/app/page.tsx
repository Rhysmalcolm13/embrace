    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span className="sr-only">OSiris</span>
        </Link>
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <br />
                    The Ultimate Platform For Innovative Minds! <br />
                    Securely build, deploy, monetize and scale <br />
                ...
                <ul className="grid gap-6">
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-400">
                        Automate your workflow with advanced AI integrations.
                      </p>
                    </div>
                  </li>
                  <li>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-neutral-500 dark:text-neutral-400">
          © 2024 OSiris All rights reserved.
        </p>
